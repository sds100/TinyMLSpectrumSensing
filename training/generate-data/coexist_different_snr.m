        ...
        for s=1:7
            ...
            switch scen(s)
                case 1 %B
                    ...
                    WaveformOut = awgn(complex(channelsig), SNR_BLUETOOTH,'measured');
                    %                       figure;
                ...
                case 2 %W
                    ...
                    channelsig=fadechannel(consig);
                    WaveformOut = awgn(complex(channelsig), SNR_WIFI,'measured');
                    %                       figure;
                ...
                case 3 %Z
                    ...
                    channelsig=fadechannel(consig);
                    WaveformOut = awgn(complex(channelsig), SNR_ZIGBEE,'measured');
                    %                          figure;
            ...
            % Save as .mat file
            filename=[file '/matlab/' 'SNR_W' num2str(SNR_WIFI) '_' 'SNR_B' num2str(SNR_BLUETOOTH) '_' 'SNR_Z' num2str(SNR_ZIGBEE) '_'  class '.mat'];
